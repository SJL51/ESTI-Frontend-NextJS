        ...
        },
        {
            ...
            childTable: {
                ...
                columns: [
                    ...
                    { fieldname: "days_approved", label: "Days Approved", fieldtype: "Float", readOnly: true },
                    { fieldname: "with_pay", label: "With Pay", fieldtype: "Float", readOnly: true },
                    { fieldname: "without_pay", label: "Without Pay", fieldtype: "Float", readOnly: true },
                    { fieldname: "immediate_superior", label: "Immediate Superior", fieldtype: "Data", readOnly: true },
                    { fieldname: "hrd_head", label: "HRD Head", fieldtype: "Data", readOnly: true },
            ...
            dialog: {
                buttonLabel: "Leave Credits",
                title: "Leave Credits",
                fieldnames: ["vacation_leave", "sick_leave"],
            },
        },
        {
            key: "benefits",
        ...
        },
        {
            ...
            childTable: {
                ...
                columns: [
                    ...
                    { fieldname: "status", label: "Status", fieldtype: "Select", options: "Pending\nApproved\nRejected", readOnly: true },
                    { fieldname: "interest_rate", label: "Interest Rate (%)", fieldtype: "Float", readOnly: true },
                    { fieldname: "term", label: "Term (months)", fieldtype: "Int", readOnly: true },
                    { fieldname: "interest_cost", label: "Interest Cost", fieldtype: "Currency", readOnly: true },
